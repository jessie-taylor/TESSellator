...
SCHEMA = OrderedDict({  # byte regions and data types for each field
        "Name": RowElement(slice(0, 10), dtype=int),
        "RAdeg": RowElement(slice(11, 26), dtype=float),
        "DEdeg": RowElement(slice(27, 41), dtype=float),
        "VType": RowElement(slice(42, 56), dtype=str_),
        "SpType": RowElement(slice(57, 75), dtype=str_),
        "f": RowElement(slice(76, 84), dtype=float),
        "M0": RowElement(slice(85, 98), dtype=float),
        "l_dT": RowElement(slice(99, 100), dtype=str_),
        "dT": RowElement(slice(100, 106), dtype=float),
        "VSX": RowElement(slice(107, 135), dtype=str_),
        "VSXType": RowElement(slice(136, 149), dtype=str_),
        "Blend": RowElement(slice(150, 159), dtype=int),
        "N": RowElement(slice(160, 162), dtype=int),
        })
